...
class Nokia(object):
    ...
    def scenery6(self,files,temp):
        ...
        data = [['sysname','chassis','source_ip','l2vpn','service_id','service_name','customer_id','sap','ingress_qos_id','egress_qos_id','port','port_description','policy','card','buffer_min','buffer_max','resv_min','resv_max','shutdown','l3vpn','service_id','service_name','customer_id']]
        ...
        for filename in tqdm(files):
            ...
            for row in fsm_results:
                ...
                if row[21] != '':
                    l3vpn_list.append({
                        ...
                        "service_name": service_name,
                        "customer_id": customer_id,
                        "l2vpn": row[21][1:-1] if re.search('"', row[21]) else row[21],
                        "name": True if re.search('"', row[21]) else False
                    })
                if row[10] != '':
            ...
            for i in l2vpn_list:
                ...
                l3vpn_in_l2vpn = [l3vpn for l3vpn in l3vpn_list if (l3vpn["name"] == True and l3vpn["l2vpn"] == i["service_name"]) or (l3vpn["name"] == False and l3vpn["l2vpn"] == i["service_id"])]
                data.append([
                    i["sysname"],
                    i["chassis"],
                    i["source_ip"],
                    ...
                    '' if card == '' else card["resv_max"],
                    '' if card == '' else card["shutdown"],
                    '' if not len(l3vpn_in_l2vpn) else l3vpn_in_l2vpn[0]["l3vpn"],
                    '' if not len(l3vpn_in_l2vpn) else l3vpn_in_l2vpn[0]["service_id"],
                    '' if not len(l3vpn_in_l2vpn) else l3vpn_in_l2vpn[0]["service_name"],
                    '' if not len(l3vpn_in_l2vpn) else l3vpn_in_l2vpn[0]["customer_id"]
                ])
    ...
    def scenery10(self,files,temp):
        ...
        return Get(200,'All files were processed correctly',data)
    def scenery10_1(self,files,temp):
        """
        Docstring for .scenery10_1(files,templates)
        file Processor for logs in scenery 10_1
        ...
        if console:
            myFile = open('Nokia_'+str(len(files))+'_files_scenery_10_11_all_isis.csv', 'w')
            with myFile:
                writer = csv.writer(myFile)
                writer.writerows(data)
    ...
    def scenery13(self,files,temp):
        ...
        data = [['sysname','chassis','source_ip','l2vpn','service_id','service_name','customer_id','sap','ingress_qos_id','egress_qos_id','port','port_description','policy','card', 'mda', 'fabric_network', 'fabric_access','l3vpn','service_id','service_name','customer_id']]
            ...
            for row in fsm_results:
                ...
                if row[19] != '':
                    l3vpn_list.append({
                        ...
                        "service_name": service_name,
                        "customer_id": customer_id,
                        "l2vpn": row[19][1:-1] if re.search('"', row[19]) else row[19],
                        "name": True if re.search('"', row[19]) else False
                    })
                if row[10] != '':
    ...
    def scenery17_9(self,files,temp):
        ...
        data = [['Sysname',
            ...
            'source',
            'description',
            'slope_policy_ntw_wred_create',
            'slope_policy_ntw_wred_description',
            'slope_policy_ntw_wred_high_slope',
            'slope_policy_ntw_wred_high_slope_start_avg',
            'slope_policy_ntw_wred_high_slope_max_avg',
            'slope_policy_ntw_wred_high_slope_max_prob',
            'slope_policy_ntw_wred_high_slope_status',
            'slope_policy_ntw_wred_low_slope',
            'slope_policy_ntw_wred_low_slope_start_avg',
            'slope_policy_ntw_wred_low_slope_max_avg',
            'slope_policy_ntw_wred_low_slope_max_prob',
            'slope_policy_ntw_wred_low_slope_status'
        ]]
    ...
    def scenery19_1(self,files,temp):
        ...
        data = [['Sysname',
                ...
                'source',
                'description',
                'ip_filter_2021_create',
                'ip_filter_2021_description',
                'ip_filter_2021_entry100_create',
                'ip_filter_2021_entry100_action',
            ]]
    ...
    def scenery19_2(self,files,temp):
        ...
        data = [['Sysname',
            ...
            'source',
            'description',
            'ip_filter_2031_create'
            'ip_filter_2031_description'
            'ip_filter_2031_entry100_create'
            'ip_filter_2031_entry100_action'
            ]]
    ...
    def scenery19_3(self,files,temp):
        ...
        data = [['Sysname',
            ...
            'source',
            'description',
            'ip_filter_3001_create'
            'ip_filter_3001_description'
            'ip_filter_3001_entry100_create'
            'ip_filter_3001_entry100_action'
        ]]
    ...
    def scenery19_4(self,files,temp):
        ...
        data = [['Sysname',
            ...
            'source',
            'description',
            'slope_policy_COS2_create'
            'slope_policy_COS2_description'
            'slope_policy_COS2_high_slope'
            'slope_policy_COS2_high_slope_start_avg'
            'slope_policy_COS2_high_slope_max_avg'
            'slope_policy_COS2_high_slope_max_prob'
            'slope_policy_COS2_high_slope_status'
            'slope_policy_COS2_low_slope'
            'slope_policy_COS2_low_slope_start_avg'
            'slope_policy_COS2_low_slope_max_avg'
            'slope_policy_COS2_low_slope_max_prob'
            'slope_policy_COS2_low_slope_status'
        ]]
    ...
    def scenery19_5(self,files,temp):
        ...
        data = [['Sysname',
            ...
            'source',
            'description',
            'slope_policy_COS3_create'
            'slope_policy_COS3_description'
            'slope_policy_COS3_high_slope'
            'slope_policy_COS3_high_slope_start_avg'
            'slope_policy_COS3_high_slope_max_avg'
            'slope_policy_COS3_high_slope_max_prob'
            'slope_policy_COS3_high_slope_status'
            'slope_policy_COS3_low_slope'
            'slope_policy_COS3_low_slope_start_avg'
            'slope_policy_COS3_low_slope_max_avg'
            'slope_policy_COS3_low_slope_max_prob'
            'slope_policy_COS3_low_slope_status'
        ]]
    ...
    def scenery19_6(self,files,temp):
        ...
        data = [['Sysname',
            ...
            'source',
            'description',
            'scheduler_access_create'
            'scheduler_access_description'
            'scheduler_access_level1'
            'scheduler_access_level2'
            'scheduler_access_level3'
            'scheduler_access_level4'
            'scheduler_access_level5'
            'scheduler_access_level6'
            'scheduler_access_level7'
            'scheduler_access_level8'
            'scheduler_access_orphan'
        ]]
...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 3:
        ...
        elif '10_1.fsm' in sys.argv[1]:
            print(this.scenery10_1(files,template).message)
